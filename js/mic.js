window.AppMedia = {
    ...
    init: function() {
        this.initMic();
        // Добавляем плавность для появления/исчезновения рамки
    ...
    toggleCam: function(forceState) {
        ...
        console.log(`[Media] Рамка ${this.camEnabled ? 'ВКЛЮЧЕНА' : 'ВЫКЛЮЧЕНА'}`);
    },
    ...
    initMic: async function() {
        try {
            ...
            console.log(`[Media] Эквалайзер подключен к микрофону: ${audioTrack.label || 'По умолчанию'}`);
